...
@TableName("fresh_news_child_comments")
public class FreshNewsChildComment implements FreshNewsComment , Serializable {
    //序列化ID
    @Serial
    private static final long serialVersionUID = -1140784236613250357L;
